...
import 'package:flutter_django_quiz_app/screen_result.dart';
...
class QuizScreen extends StatefulWidget {
  List<Quiz> quizs;
  QuizScreen({this.quizs}); // quizs 받아오기
  @override
...
class _QuizScreenState extends State<QuizScreen> {
  ...
  List<bool> _answerState = [false, false, false,false]; // 정답선택여부
  int _currentIndex = 0; //현재 퀴즈정보
      ...
      child: Column(
        ...
        children: <Widget>[
          ...
          Container(
            ...
            child: Center(child:  ButtonTheme(minWidth: width * 0.5, height: height * 0.05,
